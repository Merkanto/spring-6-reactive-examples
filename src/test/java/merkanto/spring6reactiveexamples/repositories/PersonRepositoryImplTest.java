...
class PersonRepositoryImplTest {
    ...
    void testFilterOnName() {
        personRepository.findAll()
                .filter(person -> person.getFirstName().equals("Gogo"))
                .subscribe(person -> System.out.println(person.getFirstName()));
    }

    @Test
    void testGetById() {
        Mono<Person> miroMono = personRepository.findAll().filter(person -> person.getFirstName().equals("Miro"))
                .next();
        miroMono.subscribe(person -> System.out.println(person.getFirstName()));
    }
